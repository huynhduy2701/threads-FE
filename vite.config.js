...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      "/api": {
        target: "http://localhost:5500", //Đây là đích mà các yêu cầu /api sẽ được chuyển tiếp tới. Ở đây, nó chuyển tiếp tới http://localhost:5000, nơi có thể là máy chủ backend của bạn (chẳng hạn Node.js hoặc Express).
